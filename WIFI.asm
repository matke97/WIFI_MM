...
NOP	
;WIFI.c,35 :: 		WIFI4_cmdSingle("AT+S.SCFG=","ip_use_dhcp,\"1\"");
...
NOP	
NOP	
;WIFI.c,39 :: 		mikrobus_logWrite( "GOTOVO", _LOG_LINE );
ORI	R26, R0, 2
...
_vidiipadresu:
;WIFI.c,41 :: 		void vidiipadresu()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,43 :: 		WIFI4_cmdSingle("AT+S.STS=","ip_ipaddr");
SW	R25, 4(SP)
SW	R26, 8(SP)
...
_pisiWIFIstatus:
;WIFI.c,46 :: 		void pisiWIFIstatus()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,48 :: 		WIFI4_cmdSingle("AT+S.STS=","wifi_state");
SW	R25, 4(SP)
SW	R26, 8(SP)
...
_systemInit:
;WIFI.c,51 :: 		void systemInit()
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;WIFI.c,54 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_RST_PIN, _GPIO_OUTPUT );
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
MOVZ	R27, R0, R0
...
NOP	
;WIFI.c,55 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_CS_PIN, _GPIO_INPUT );
ORI	R27, R0, 1
ORI	R26, R0, 2
MOVZ	R25, R0, R0
JAL	_mikrobus_gpioInit+0
NOP	
;WIFI.c,56 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_INT_PIN, _GPIO_OUTPUT );
MOVZ	R27, R0, R0
ORI	R26, R0, 7
MOVZ	R25, R0, R0
JAL	_mikrobus_gpioInit+0
NOP	
;WIFI.c,57 :: 		mikrobus_uartInit(_MIKROBUS1,&_WIFI4_UART_CFG[0]);
...
NOP	
;WIFI.c,59 :: 		mikrobus_logInit(_LOG_USBUART_B,115200);
LUI	R26, 1
ORI	R26, R26, 49664
ORI	R25, R0, 48
...
; end of _systemInit
_defaultHandler:
;WIFI.c,61 :: 		void defaultHandler(uint8_t *resp,uint8_t *args)
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;WIFI.c,63 :: 		mikrobus_logWrite(resp,_LOG_LINE);
SW	R26, 4(SP)
ORI	R26, R0, 2
JAL	_mikrobus_logWrite+0
NOP	
...
_appInit:
;WIFI.c,66 :: 		void appInit()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,68 :: 		WIFI4_uartDriverInit((T_WIFI4_P)&_MIKROBUS1_GPIO,(T_WIFI4_P)&_MIKROBUS1_UART);
SW	R25, 4(SP)
SW	R26, 8(SP)
...
NOP	
NOP	
;WIFI.c,75 :: 		WIFI4_modulePower(0);
MOVZ	R25, R0, R0
JAL	_WIFI4_modulePower+0
NOP	
;WIFI.c,76 :: 		Delay_100ms();
JAL	_Delay_100ms+0
NOP	
;WIFI.c,77 :: 		WIFI4_modulePower(1);
ORI	R25, R0, 1
JAL	_WIFI4_modulePower+0
NOP	
;WIFI.c,78 :: 		Delay_ms(1000);
LUI	R24, 406
ORI	R24, R24, 59050
L_appInit5:
ADDIU	R24, R24, -1
...
JAL	_WIFI4_cmdSingle+0
NOP	
;WIFI.c,83 :: 		nakacisena_gateway();
JAL	_nakacisena_gateway+0
NOP	
;WIFI.c,84 :: 		WIFI4_cmdSingle("AT&V","");
...
; end of _appInit
_appTask:
;WIFI.c,88 :: 		void appTask()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,90 :: 		WIFI4_process();
SW	R25, 4(SP)
SW	R26, 8(SP)
JAL	_WIFI4_process+0
NOP	
;WIFI.c,92 :: 		mikrobus_logWrite("PRVA KOMANDA",_LOG_LINE);
ORI	R26, R0, 2
LUI	R25, hi_addr(?lstr15_WIFI+0)
ORI	R25, R25, lo_addr(?lstr15_WIFI+0)
JAL	_mikrobus_logWrite+0
NOP	
;WIFI.c,93 :: 		vidiipadresu();
JAL	_vidiipadresu+0
NOP	
;WIFI.c,94 :: 		Delay_ms(500);
LUI	R24, 203
ORI	R24, R24, 29524
L_appTask9:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;WIFI.c,95 :: 		mikrobus_logWrite("DRUGA KOMANDA",_LOG_LINE);
ORI	R26, R0, 2
LUI	R25, hi_addr(?lstr16_WIFI+0)
ORI	R25, R25, lo_addr(?lstr16_WIFI+0)
JAL	_mikrobus_logWrite+0
NOP	
;WIFI.c,96 :: 		pisiWIFIstatus();
JAL	_pisiWIFIstatus+0
NOP	
;WIFI.c,97 :: 		Delay_ms(4000);
LUI	R24, 1627
ORI	R24, R24, 39594
L_appTask11:
ADDIU	R24, R24, -1
...
; end of _appTask
_main:
;WIFI.c,102 :: 		void main() {
;WIFI.c,103 :: 		systemInit();
JAL	_systemInit+0
NOP	
;WIFI.c,104 :: 		appInit();
JAL	_appInit+0
NOP	
;WIFI.c,106 :: 		mikrobus_logWrite("PROBA",_LOG_LINE);
ORI	R26, R0, 2
