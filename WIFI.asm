...
NOP	
;WIFI.c,34 :: 		WIFI4_cmdSIngle("AT+S.WIFI=","0");
...
NOP	
;WIFI.c,42 :: 		WIFI4_cmdSIngle("AT+S.WIFI=","1");
...
_systemInit:
;WIFI.c,57 :: 		void systemInit()
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;WIFI.c,60 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_RST_PIN, _GPIO_OUTPUT );
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
MOVZ	R27, R0, R0
...
NOP	
;WIFI.c,61 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_CS_PIN, _GPIO_INPUT );
ORI	R27, R0, 1
ORI	R26, R0, 2
MOVZ	R25, R0, R0
JAL	_mikrobus_gpioInit+0
NOP	
;WIFI.c,62 :: 		mikrobus_gpioInit( _MIKROBUS1, _MIKROBUS_INT_PIN, _GPIO_OUTPUT );
MOVZ	R27, R0, R0
ORI	R26, R0, 7
MOVZ	R25, R0, R0
JAL	_mikrobus_gpioInit+0
NOP	
;WIFI.c,63 :: 		mikrobus_uartInit(_MIKROBUS1,&_WIFI4_UART_CFG[0]);
...
NOP	
;WIFI.c,65 :: 		mikrobus_logInit(_LOG_USBUART_B,115200);
LUI	R26, 1
ORI	R26, R26, 49664
ORI	R25, R0, 48
...
; end of _systemInit
_defaultHandler:
;WIFI.c,67 :: 		void defaultHandler(uint8_t *resp,uint8_t *args)
ADDIU	SP, SP, -8
SW	RA, 0(SP)
;WIFI.c,69 :: 		mikrobus_logWrite(resp,_LOG_LINE);
SW	R26, 4(SP)
ORI	R26, R0, 2
JAL	_mikrobus_logWrite+0
NOP	
...
_appInit:
;WIFI.c,72 :: 		void appInit()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,74 :: 		WIFI4_uartDriverInit((T_WIFI4_P)&_MIKROBUS1_GPIO,(T_WIFI4_P)&_MIKROBUS1_UART);
SW	R25, 4(SP)
SW	R26, 8(SP)
...
NOP	
;WIFI.c,75 :: 		InitTimer1();
JAL	_InitTimer1+0
NOP	
;WIFI.c,76 :: 		uartInterrupt();
JAL	_uartInterrupt+0
NOP	
;WIFI.c,77 :: 		WIFI4_coreInit(defaultHandler,1500);
ORI	R26, R0, 1500
...
; end of _appInit
_appTask:
;WIFI.c,94 :: 		void appTask()
ADDIU	SP, SP, -12
SW	RA, 0(SP)
;WIFI.c,96 :: 		WIFI4_process();
SW	R25, 4(SP)
SW	R26, 8(SP)
JAL	_WIFI4_process+0
NOP	
;WIFI.c,98 :: 		mikrobus_logWrite("PRVA KOMANDA",_LOG_LINE);
ORI	R26, R0, 2
LUI	R25, hi_addr(?lstr19_WIFI+0)
ORI	R25, R25, lo_addr(?lstr19_WIFI+0)
JAL	_mikrobus_logWrite+0
NOP	
;WIFI.c,99 :: 		vidiipadresu();
JAL	_vidiipadresu+0
NOP	
;WIFI.c,100 :: 		WIFI4_ping("8.8.8.8");
LUI	R25, hi_addr(?lstr20_WIFI+0)
ORI	R25, R25, lo_addr(?lstr20_WIFI+0)
JAL	_WIFI4_ping+0
NOP	
;WIFI.c,101 :: 		Delay_ms(500);
LUI	R24, 203
ORI	R24, R24, 29524
L_appTask9:
ADDIU	R24, R24, -1
...
NOP	
NOP	
;WIFI.c,102 :: 		mikrobus_logWrite("DRUGA KOMANDA",_LOG_LINE);
ORI	R26, R0, 2
...
; end of _appTask
_main:
;WIFI.c,109 :: 		void main() {
;WIFI.c,110 :: 		systemInit();
JAL	_systemInit+0
NOP	
;WIFI.c,111 :: 		appInit();
JAL	_appInit+0
NOP	
;WIFI.c,113 :: 		mikrobus_logWrite("PROBA",_LOG_LINE);
ORI	R26, R0, 2
